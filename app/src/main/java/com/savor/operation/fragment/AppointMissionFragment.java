...
public class AppointMissionFragment extends BaseFragment implements ApiRequestListener,
    ...
    public static AppointMissionFragment getInstance(int type) {
        AppointMissionFragment missionFragment = new AppointMissionFragment();
...
//                    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 666&&resultCode!=TaskDetailActivity.RESULT_CODE_BACK) {
            //pullToRefreshListView.onLoadComplete(true,false);
