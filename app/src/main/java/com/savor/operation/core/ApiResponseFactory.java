...
import com.savor.operation.bean.BaseProResponse;
import com.savor.operation.bean.BottomHotelVodList;
import com.savor.operation.bean.CategoryBottomList;
import com.savor.operation.bean.CategoryItemVo;
import com.savor.operation.bean.CheckApInfo;
import com.savor.operation.bean.CommonListItem;
import com.savor.operation.bean.CommonListResult;
import com.savor.operation.bean.GameResult;
import com.savor.operation.bean.HotelMapBean;
import com.savor.operation.bean.PictureSetBean;
import com.savor.operation.bean.SmallPlatformByGetIp;
import com.savor.operation.bean.SmashEgg;
import com.savor.operation.bean.SpecialDetail;
import com.savor.operation.bean.SpecialList;
import com.savor.operation.bean.SpecialNameResult;
import com.savor.operation.bean.StartUpSettingsBean;
import com.savor.operation.bean.LastTopList;
import com.savor.operation.bean.LocalVideoProPesponse;
import com.savor.operation.bean.QuerySeekResponse;
import com.savor.operation.bean.RotateProResponse;
import com.savor.operation.bean.SeekProResponseVo;
import com.savor.operation.bean.TopHotelVodList;
import com.savor.operation.bean.TvBoxInfo;
import com.savor.operation.bean.UpgradeInfo;
import com.savor.operation.bean.VodListBean;
import com.savor.operation.bean.VodProResponse;
import com.savor.operation.bean.VolProResponseVo;
...
import static com.savor.operation.core.AppApi.Action.POST_CHECKAP_CONNECTION_JSON;
import static com.savor.operation.core.AppApi.Action.GET_NOTIFY_PAUSE_JSON;
import static com.savor.operation.core.AppApi.Action.POST_NOTIFY_REPLAY_JSON;
import static com.savor.operation.core.AppApi.Action.POST_NOTIFY_VOL_DOWN_JSON;
import static com.savor.operation.core.AppApi.Action.POST_NOTIFY_VOL_OFF_JSON;
import static com.savor.operation.core.AppApi.Action.POST_NOTIFY_VOL_ON_JSON;
import static com.savor.operation.core.AppApi.Action.POST_NOTIFY_VOL_UP_JSON;
import static com.savor.operation.core.AppApi.Action.POST_SEEK_CHANGE_JSON;
